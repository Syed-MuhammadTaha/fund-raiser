...
const {test,loginUser,getProfile,registerUser,verifyMail, createCampaign,PasswordReset,NewPassword, stripeIntegration,logsout, CampaignDetails} = require('../controllers/authControllers')
...
router.get('/fundraiserInfo', CampaignDetails)

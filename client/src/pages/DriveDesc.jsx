        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              Are you sure you want to create the drive with the given
              details?
            </div>
